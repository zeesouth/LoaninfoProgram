		   ...
		   <section id="cont_center">
			<form action="insertUser.do" method="get">
				<table class="table table-bordered" border="0">
					<h4 class="col_tit">회원 가입</h4>
					
					<tr>
						<td> 회원 번호 </td>
						<td> <input type="text" name="u_id" disabled="disabled" value="<%=String.format("%08d", cnt)%>"/> </td>
					</tr>
					...
					<td> 정보 </td>
						<td>
							<textarea rows="10" cols="80" placeholder="500자 이내" style="resize:none;" name="info"></textarea>
						</td>
					</tr>
				...
				<div align="center">
					...
					<input type="button" onclick="location.href='/selectAllUserList.do'" value="취소"/>
				</div>
			</form>
		</section>
